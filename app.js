var ideasList = ["Try to grow an avocado: it will die in a few weeks, but at least you can say you tried.",
...
function run() { //displays random task in div class="task", sets button html
  var task = ideasList[Math.floor(Math.random() * ideasList.length)];
  document.getElementById("task").innerHTML = task;
  document.getElementById("main-button").innerText = "Want another idea?";
}

function loading() { //cool timer effects
  setTimeout(run, 800)
  document.getElementById("task").innerHTML = '<div class="spinner-grow text-dark"></div>';
}

function setButtonText() { //sets initial button html
  document.getElementById("main-button").innerText = "Click me!";
}

// buttonStart = () => {
//   document.getElementById("main-button").addEventListener("load", setButtonText);
// }


//   var buttonText = (running ?  : "Click me!");
//   console.log("buttonText= " + buttonText);
//   document.getElementById("main-button").innerText = buttonText;
// }
//
